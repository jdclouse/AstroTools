...
hw_pub.script_list = {};
hw_pub.script_list = [hw_pub.script_list 'HW2_P1'];
hw_pub.script_list = [hw_pub.script_list 'HW2_P2'];
hw_pub.script_list = [hw_pub.script_list 'HW2_P3'];
hw_pub.script_list = [hw_pub.script_list 'HW2_P4'];
hw_pub.script_list = [hw_pub.script_list 'HW2_P5'];
hw_pub.script_list = [hw_pub.script_list 'HW2_P6'];
