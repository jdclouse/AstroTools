...
hw_pub.script_list = {};
hw_pub.script_list = [hw_pub.script_list 'HW9_P1'];
hw_pub.script_list = [hw_pub.script_list 'HW9_P2'];
hw_pub.script_list = [hw_pub.script_list 'HW9_P3'];
hw_pub.script_list = [hw_pub.script_list 'HW9_P4'];
