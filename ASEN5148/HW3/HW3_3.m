...
if prop_lv_ss < 0
    ...
    fprintf('\tTotal prop: Single-stage LV: %.4f kg\n', p_tot)
    fprintf('\tTotal launch mass: Single-stage LV: %.4f kg\n\n', mass_lv_ss)
end

p_tot = prop_at_mars+prop_at_x+prop_lv_2s_2+prop_lv_2s_1;
fprintf('\tTotal prop: 2-stage LV: %.4f kg\n', p_tot)
fprintf('\tTotal launch mass: 2-stage LV: %.4f kg\n\n', mass_lv_2s_1)

p_tot = prop_at_mars+prop_at_x+prop_lv_3s_3+prop_lv_3s_2+prop_lv_3s_1;
fprintf('\tTotal prop: 3-stage LV: %.4f kg\n', p_tot)
fprintf('\tTotal launch mass: 3-stage LV: %.4f kg\n\n', mass_lv_3s_1)
end