...
clc
hw_pub.toolsPath = @(x) ...
    strcat('C:\Users\John\Documents\Astro\ASEN6008_IMD\tools\',x);
if ispc
    addpath(hw_pub.toolsPath(''))
end

hw_pub.script_list = {};
hw_pub.script_list = [hw_pub.script_list 'HW6_P1'];
hw_pub.script_list = [hw_pub.script_list 'HW6_P2'];
hw_pub.script_list = [hw_pub.script_list 'HW6_P3'];
hw_pub.script_list = [hw_pub.script_list 'HW6_P4'];
