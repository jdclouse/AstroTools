...
BEGIN Epoch
    ...
    Epoch        1 Jan 2000 00:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Jan 2000 00:00:00.000000000
			EventEpoch
...
BEGIN Animation
    ...
    EndTime            2 Jan 2000 00:00:00.000000000
    CurrentTime        1 Jan 2000 00:00:00.000000000
    Direction          Forward
...
END MapData
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	24 Jan 2016 19:00:00.000000000
				Stop	25 Jan 2016 19:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Facility/DSN_Aus
        Facility/DSN_Aus
        Satellite/LEO/Sensor/Track
    END Instance
    Instance Facility/DSN_Cal
        Facility/DSN_Cal
        Facility/DSN_Cal/Sensor/Uplink
        Satellite/LEO/Sensor/Track
    END Instance
    Instance Facility/DSN_Cal/Sensor/Uplink
        Facility/DSN_Cal/Sensor/Uplink
    END Instance
    Instance Facility/DSN_Spa
        Facility/DSN_Spa
        Satellite/LEO/Sensor/Track
    END Instance
    ...
    Instance Satellite/LEO
        Facility/DSN_Cal/Sensor/Uplink
        Satellite/LEO
        Satellite/LEO/Sensor/Image
        Satellite/LEO/Sensor/Track
    END Instance
    Instance Satellite/LEO/Sensor/Image
        Satellite/LEO/Sensor/Image
    END Instance
    Instance Satellite/LEO/Sensor/Track
        Satellite/LEO/Sensor/Track
    END Instance
