...
% Filter Options
filter_opts.propagator_opts.PV_prop_opts = PV_prop_opts;
filter_opts.propagator_opts.att_prop_opts = att_prop_opts;
...
filter_opts.PV_state = [r_init; v_init];
filter_opts.R = eye(3)*(1e-6)^2;
