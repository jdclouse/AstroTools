...
xy_off = (mu_sun + srp_wrt_r)*(3*(R_s_e_x - x)*(R_s_e_y - y)/norm_del_5);
xz_off = (mu_sun + srp_wrt_r)*(3*(R_s_e_x - x)*(R_s_e_z - z)/norm_del_5);
yz_off = (mu_sun + srp_wrt_r)*(3*(R_s_e_y - y)*(R_s_e_z - z)/norm_del_5);
