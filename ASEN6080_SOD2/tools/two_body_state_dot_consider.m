function state_dot = two_body_state_dot_consider(t, state, opts)
...
%         long_dim = 9;
%         STM = zeros(long_dim);
        STM = reshape(state(opts.OD.state_len+aug_len+1:opts.OD.state_len+opts.OD.A_params.important_block(1)*opts.OD.A_params.important_block(1)),...
